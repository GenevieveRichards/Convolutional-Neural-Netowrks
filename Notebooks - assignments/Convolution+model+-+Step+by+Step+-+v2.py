        ...
        for h in range(n_H):                     # loop on the vertical axis of the output volume
            for w in range(n_W):                 # loop on the horizontal axis of the output volume
                for c in range (n_C):            # loop over the channels of the output volume
                    ...
                    a_prev_slice = A_new[vert_start : vert_end,horiz_start : horiz_end,:]
...
def conv_backward(dZ, cache):
    ...
    for i in range(m):                       # loop over the training examples
        ...
        for h in range(int(n_H)):                   # loop over vertical axis of the output volume
            for w in range(int(n_W)):               # loop over horizontal axis of the output volume
                for c in range(int(n_C)):           # loop over the channels of the output volume
...
def pool_backward(dA, cache, mode = "max"):
    ...
    for i in range(m):                       # loop over the training examples
        ...
        for h in range(int(n_H)):                   # loop on the vertical axis
            for w in range(int(n_W)0:               # loop on the horizontal axis
                for c in range(int(n_C)):           # loop over the channels (depth)
                    ...
                    if mode == "max":
                        ...
                        mask = reate_mask_from_window(a_prev_slice)
