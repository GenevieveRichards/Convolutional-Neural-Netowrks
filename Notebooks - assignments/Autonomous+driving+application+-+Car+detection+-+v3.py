...
def yolo_filter_boxes(box_confidence, boxes, box_class_probs, threshold = .6):
    ...
    box_classes = K.argmax(box_scores, axis=-1) # This is finding the argument that corresponds to the maximum value 
    box_class_scores = K.max(box_scores, axis=-1) # This is storing the maximum value 
    ### END CODE HERE ###
